...
public class ApaAp_RPG {
    ...
    public static void main(String[] args) {
       ...
       switch (testCase) {
           ...
           case 6: 
               ...
               System.out.println("Character after receiving 30 damage - Health: " + swordsman.getHealth());
               
               paladin.receiveDamage(40);
               System.out.println("Character after receiving 40 damage - Health: " + paladin.getHealth());
               break;
           ...
           case 7: 
               ...
               paladin.resurrect();
               System.out.println("Character after resurrecting - Health: " + paladin.getHealth());
               paladin.resurrect();
               break;
               
           case 8:
               System.out.println("Testing if Swordsman is a child Character");
    ...
    private static void testFieldPrivacy(Paladin paladin) {
